...
public class Google_Test {
    ...
    public void login() {
        login_page.enterToGoogleAccount(Constants.LOGIN, Constants.PASSWORD);
    ...
    public void sendNewLetter() {
        main_page.sendLetter(Constants.LOGIN + Constants.DOMAIN, Constants.TOPIC, Constants.MESSAGEBODY);
